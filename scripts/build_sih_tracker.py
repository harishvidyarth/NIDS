...
SHEETS: dict[str, dict] = {
    "Overview": {
        ...
        "rows": [
            ...
            ["Repo", "github.com/harishvidyarth/NIDS"],
            ["Public code link (E1)", "TBD — Harish"],
            ["Demo video link (E4)", "TBD — Sujitha builds file, Harish posts link"],
            ["Slides link (E5)", "TBD — Sujitha builds deck, Harish posts link"],
    ...
    "PS Completion": {
        ...
        "rows": [
            ...
            ["E1", "Source code link (GitHub/Drive)", "Harish", "", 50, "",
             "github.com/harishvidyarth/NIDS", "confirm repo public; prep Drive zip fallback (D5)"],
            ["E2", "README with setup", "Kaviya", "", 80, "",
             "README.md", "add a fresh-machine setup section (.venv-lstm312, run_backend.sh, :8765)"],
            ["E3", "Architecture doc (max 2 pages)", "Archana", "", 30, "",
             "reports/NIDS_System_Guide_and_Roadmap.pdf; PIPELINE.md; PROTOTYPE.md", "write the 2-page judge-facing doc; single state story (D6)"],
            ["E4", "Demo video (max 2 min)", "Sujitha", "", 15, "",
             "-- (script not yet migrated from NAF)", "Sujitha edits in Canva / CapCut; script + recording both to do"],
            ["E5", "Technical presentation (max 5 slides)", "Sujitha", "", 20, "",
             "reports/ figures + NIDS_Product_Description.pdf", "Sujitha builds in Canva from reports/ + the E3 arch doc"],
        ],
    },
    "Team & Work Split": {
