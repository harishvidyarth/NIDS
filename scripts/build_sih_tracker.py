...
SHEETS: dict[str, dict] = {
    ...
    "Team & Work Split": {
        ...
        "rows": [
            ["Harish Vidyarth N", "Development — model & forecast core", "ML / PyTorch; repo admin",
             "harishvidyarthcsecs", "R2, R7, D4",
             "dual-head LSTM + K-step rollout; leakage-safe splits + per-class recall + retrain to a passing release gate (D4); LogReg benchmark (R7); CI, branch protection, release tag; mentors Manjari on the attack side"],
            ["Kaviya V", "Development — platform core + PM", "AI prototype development; Team Lead",
             "kaviya (branch)", "R6",
             "FastAPI + Next.js cockpit + Streamlit; docker compose one-command demo; PCAP/CSV upload; STIX-lite alert + SOC PDF wiring (R6); owns Milestones tab + daily-report enforcement"],
            ...
            ["Sujitha", "Media & Submission", "PPT, frontend UI/UX", "",
             "E1, E2, E4, E5 build, D5",
             "builds the 5-slide deck + 2-min demo video; cockpit UI/UX polish; README polish; SIH portal submission text; make repo public / prepare Drive code link (D5)"],
        ],
    },
    "Milestones": {
        "headers": ["Phase", "Window", "Goal", "Owner", "Status", "Evidence link"],
        "rows": [
            ["0", "Sep 1", "Tracker sheet live; PS saved; roles locked; commit + push the WIP; tag v0.3-pre-sih", "Kaviya / Harish / Sujitha", "Not started", ""],
            ...
            ["3", "Sep 12-15", "2-min demo video (E4); 5-slide deck (E5); docker compose one-command demo on a clean machine; Manjari attack-training run", "Sujitha (deck/video) / Kaviya / Manjari", "Not started", ""],
            ["4", "Sep 16-18", "Buffer + polish; judge Q&A prep; portal submission text; repo public / Drive link (E1, D5); pitch dry-run", "Manjari (pitch) / Sujitha / all", "Not started", ""],
            ["Submit", "Sep 19", "Submit on the SIH portal (1-day buffer before 20 Sep)", "Sujitha (Harish confirms)", "Not started", ""],
        ],
    },
    "Daily Reports": {
    ...
    "Deviations": {
        ...
        "rows": [
            ...
            ["D5", "Repo private + ~67 uncommitted working-tree changes -> reproducibility / hygiene risk for judges", "Medium", "Sujitha", "Commit + push the WIP, tag a release, make the repo public (or export a clean Drive zip) before submission", "Open", ""],
