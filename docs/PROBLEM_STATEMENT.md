# SIH26153 — Problem Statement (verbatim capture)

> Saved 2026-08-31. This file is the team's canonical copy of the problem
> statement. The body text is quoted from the SIH 2026 problem-statement data
> as published on sih.gov.in and mirrored by the community scrape cited below
> (individual sih.gov.in PS pages render behind a JS app; the official master
> PDF is image-only and not text-extractable).

## Identifiers

| Field | Value |
|---|---|
| PS number | **SIH26153** (S.No. 153) |
| Title | **AI based Network Attack Forecasting from Network Traffic Data** |
| Organisation / proposer | National Technical Research Organisation (NTRO) |
| Category | Software |
| Theme / bucket | Blockchain & Cybersecurity |
| Idea submission deadline | **20 September 2026** |
| YouTube / contact | none listed |
| Carry-over? | No — fresh SIH 2026 (9th edition) NTRO problem statement; PS list launched 21 August 2026 |

## Sources

- Official portal: <https://sih.gov.in/> (SIH 2026 problem statements, launched 21 Aug 2026)
- Verbatim text mirror: NoBugNinja, *Smart India Hackathon SIH 2026 Problem Statements* — `data/sih2026_ps_20260822_211225.json` — <https://github.com/NoBugNinja/Smart-India-Hackathon-SIH-2026-Problem-Statements> (scraped 22 Aug 2026)
- Corroborating index: <https://blinknbuild.in/sih> · <https://sih2026.vuce.in/> · <https://www.codehuntersacademy.com/sih-2026-ps>
- PS launch: *Launch of the 9th Edition of SIH 2026 Problem Statements* — <https://www.youtube.com/watch?v=2RaZ7moTzoQ>
...
## Expected Solution (Indicative) — verbatim
...
## Expected Solution / Deliverables for Evaluation — verbatim
...
## Datasets / resources mentioned — verbatim
...
Body text also explicitly names **CIC-IDS-2018** and **CTU-13** as the reference
ingestion formats, and **Scapy / PyShark** for PCAP parsing.

---

## Requirement checklist (used by the PS Completion tracker)

| # | Requirement | Notes |
|---|---|---|
| R1 | Feature extraction pipeline: flow CSV (CIC-IDS-2018 / CTU-13) **and/or** raw PCAP (Scapy/PyShark) -> timestamped, normalised matrix, **both** flow-level and packet-level attributes | packet-level is called "required" in the body |
| R2 | Trained world model (LSTM / Transformer / GNN) learning state-transition dynamics, **not** a static classifier; training scripts + weights + reproducible config included | |
| R3 | Trained via supervised dynamics learning from dataset attack-timeline annotations; **generalises to unseen attack patterns** | |
| R4 | Infiltration prediction engine: K-step forward simulation -> (a) infiltration probability time-series, (b) predicted MITRE ATT&CK stage, (c) top driving features | 5 stages: Recon, Initial Access, Lateral Movement, C2, Exfiltration |
| R5 | Explainability per prediction via SHAP **or** attention — no black-box output | |
| R6 | Working offline demo (Streamlit / Flask / CLI) accepting PCAP **or** CSV; shows infiltration probability timeline, flagged flows, attack-stage annotations; no cloud API | |
| R7 | Benchmark vs a logistic-regression baseline on the same features: F1, precision, recall, false-positive rate; show measurable improvement | |
| R8 | Applicability to enterprise + Critical Information Infrastructure demonstrated | framing / narrative requirement |
| E1 | Deliverable: source code link (GitHub / Drive) | |
| E2 | Deliverable: README with setup instructions | |
| E3 | Deliverable: architecture document, max 2 pages | |
| E4 | Deliverable: demo video, max 2 minutes | |
| E5 | Deliverable: technical presentation, max 5 slides | |
